...
import { reducers, RegistryContext, tableReducer, entitesDetailReducer } from './store';
import { mergeWithEntities, mergeWithDetail } from './store/reducers';
...
export const Routes = () => {
    ...
    useEffect(() => {
        getRegistry().register({
            ...
            ...mergeWithDetail(entitesDetailReducer()),
            systemProfileStore
        });
    }, [getRegistry]);
